...
namespace MSI.Catastros.Web.Funcionalidad.GestionDocumentos
{
    public class GestionDocumentosViewModel
    {
    ...
    public class FiltrarRecepcionDocumentosViewModel : GestionDocumentosViewModel
    {
