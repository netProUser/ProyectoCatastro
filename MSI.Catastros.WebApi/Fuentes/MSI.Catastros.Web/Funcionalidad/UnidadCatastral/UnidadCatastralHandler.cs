...
namespace MSI.Catastros.Web.Funcionalidad.UnidadCatastral
{
    public class UnidadCatastralHandler
    {
       ...
       public BE.SIC_RETORNO ProcesarUnidadCatastral(UnidadCatastralViewModel UnidadCatastral)
        {
       ...
       public Nullable<bool> GrabarUnidadImagen(UnidadCatastralViewModel UnidasCatastral)
       {
           BE.SIC_UNIDAD entQuery = new BE.SIC_UNIDAD()
           {
        ...
        public UnidadCatastralViewModel RecuperarUnidad(int? Coduni)
        {
            BE.SIC_UNIDAD entQuery = new BE.SIC_UNIDAD()
            {
                CODUNI = Coduni,
            ...
            UnidadCatastralViewModel dataQuery;
            if (query != null)
            {
                
                dataQuery = new UnidadCatastralViewModel()
                {
                    Cuc = query.TXTCUC,
        ...
        //UNID
       public string RecuperarLoteImagen(UnidadCatastralViewModel UnidadCatras)
       {
           BE.SIC_UNIDAD entQuery = new BE.SIC_UNIDAD()
           {
       ...
       public UnidadCatastralViewModel RecuperarUnidadCatastral(int CodigoUniCat, out bool resul)
       {
           BE.SIC_UNIDAD entQuery = new BE.SIC_UNIDAD();
       ...
       public UnidadCatastralViewModel RecuperarUnidadCatastralEST(int CodigoUniCat, bool Estatico, out bool resul)
       {
           BE.SIC_UNIDAD entQuery = new BE.SIC_UNIDAD();
           entQuery.CODUNI = CodigoUniCat;
       ...
       public List<BE.SIC_RETORNO> GrabarUnidadNuevo(List<SolicitudUnidadViewModel> UnidadCatastral, int contProceso = 0)
       {
           ...
           foreach (SolicitudUnidadViewModel ItemUnidad in UnidadCatastral)
           {
               ...
               switch (entSIC_RETORNO_NUEVO.NoMENSAJE) {
                   case 0: entSIC_RETORNO_NUEVO.MENSAJE = entQuery.CODDISTRITO + "-" + entQuery.CODSECTOR + "-" + entQuery.CODMANZANA + "-" +
                   ...
                   case -20001: entSIC_RETORNO_NUEVO.MENSAJE = entQuery.CODDISTRITO + "-" + entQuery.CODSECTOR + "-" + entQuery.CODMANZANA + "-" +
                   ...
                   case -20002: entSIC_RETORNO_NUEVO.MENSAJE = entQuery.CODDISTRITO + "-" + entQuery.CODSECTOR + "-" + entQuery.CODMANZANA + "-" +
                       ...
                       entSIC_RETORNO_NUEVO.Ok = false; break;
                   case -20003: entSIC_RETORNO_NUEVO.MENSAJE = entQuery.CODDISTRITO + "-" + entQuery.CODSECTOR + "-" + entQuery.CODMANZANA + "-" +
       ...
       public List<SelectListItem> ListadoLoteVia(UnidadCatastralViewModel Unidad, string Asignacion)
       {
       ...
       public List<SelectListItem> ListadoCuadra(UnidadCatastralViewModel Unidad, string concodvia)
       {
       ...
       public List<SelectListItem> ListadoLado(UnidadCatastralViewModel Unidad, string concodvia, int cuadra)
       {
           String[] substrings = concodvia.Split('-');
       ...
       public List<SelectListItem> ListadoEdificacion(UnidadCatastralViewModel Unidad, string concodvia, int cuadra, string lado)
       {
           String[] substrings = concodvia.Split('-');
       ...
       public List<SelectListItem> ListadoPuerta(UnidadCatastralViewModel Unidad, string concodvia, int cuadra, string lado, string edificacion)
       {
           String[] substrings = concodvia.Split('-');
       ...
       public Nullable<bool> GrabarLoteLinderos(List<QuintaLinderosViewModel> Lote, int contProceso = 0)
       {
           foreach (QuintaLinderosViewModel ItemLote in Lote)
           {
               ...
               {
                   case "1": entSIC_RETORNO = new BL.SIC_QUINTALINDERO().Grabar(entQuery);
