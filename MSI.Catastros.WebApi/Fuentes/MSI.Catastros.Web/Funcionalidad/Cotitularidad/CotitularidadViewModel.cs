...
{
    public class CotitularidadViewModel
    {
    ...
    public class UnidadSolicitudViewModel : FiltrarLotes
    {
        public string CodigoNumeroSolicitud { get; set; }
    }
    public class FiltrarUnidadCatastralViewModel : CotitularidadViewModel
    {
        ...
        public string FiltrarNECodigoDistrito { get; set; }
        public string FiltrarNECodigoSector { get; set; }
        public string FiltrarNECodigoManzana { get; set; }
        public string FiltrarNECodigoLote { get; set; }
        public string FiltrarNEEd { get; set; }
        public string FiltrarNEEntrada { get; set; }
        public string FiltrarNEPiso { get; set; }
        public string FiltrarNEUnidad { get; set; }
        // lbarrientos - f
    }
    ...
    public class FiltrarNumeroPredioViewModel : CotitularidadViewModel
    {
    ...
    public class NumeracionPredioViewModel
    {
        ...
        public bool Estatico { get; set; }
        public int FlagDireccion { get; set; }
    }
    ...
    public class UnidadTitularViewModel
    {
        ...
        public string TipoBlockTorre { get; set; }
    ...
    public class QuintaLinderosViewModel : FiltrarLotes
    {
        ...
        public string Codigo { get; set; }
        public bool Estatico { get; set; }
        public Int32? codUniCat { get; set; }
        ...
        public string CodigoUnidadColidante { get; set; }
