...
{
    public class MantCartasHandler
    {
        public Nullable<bool> GrabarNuevoMantCarta(CartasConfigViewModel Informe)
        {
        ...
        public Nullable<bool> GrabarMantCarta(CartasConfigViewModel Informe)
        {
            BE.SIC_CARTACONFI entQuery = new BE.SIC_CARTACONFI()
            {
        ...
        public CartasConfigViewModel RecuperarMantCarta(CartasConfigViewModel FiltrarInformes, out bool resul)
        {
            BE.SIC_CARTACONFI entQuery = new BE.SIC_CARTACONFI()
            {
            ...
            BE.SIC_CARTACONFI srcQuery = new BL.SIC_CARTACONFI().Recuperar(entQuery);
            CartasConfigViewModel lisDataQuery = new CartasConfigViewModel();
            if (srcQuery != null)
            {
        ...
        public List<SelectListItem> ListarCodigoCartas(CartasConfigViewModel CartasConfig)
        {
