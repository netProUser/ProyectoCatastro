...
namespace MSI.Catastros.BusinessEntities
{
    public partial class SIC_TIPOLLENA
    {
        ...
        public Nullable<int> NUMTIEDIAS { get; set; }
        public Nullable<int> NUMTPROGINSPE { get; set; }
        public Nullable<int> NUMTPROCINSPE { get; set; }
        public Nullable<int> NUMTPROAC { get; set; }
        public Nullable<int> NUMTPROAF { get; set; }
    }
}
