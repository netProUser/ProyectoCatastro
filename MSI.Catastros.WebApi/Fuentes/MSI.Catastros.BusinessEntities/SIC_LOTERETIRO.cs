...
namespace MSI.Catastros.BusinessEntities
{
    public partial class SIC_LOTERETIRO
    {
        ...
        public string CODCORRLOTERETI { get; set; }
        public Nullable<decimal> NUMRETIMUNI { get; set; }
        public Nullable<decimal> NUMJARDAISL { get; set; }
        public Nullable<decimal> NUMVEREDA { get; set; }
        public Nullable<decimal> NUMBERMA { get; set; }
        public Nullable<decimal> NUMPISTA { get; set; }
        public Nullable<decimal> NUMANCHVIA { get; set; }
