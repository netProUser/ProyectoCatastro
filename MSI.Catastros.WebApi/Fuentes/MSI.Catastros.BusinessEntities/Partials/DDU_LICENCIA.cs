...
namespace MSI.Catastros.BusinessEntities
{
    public partial class DDU_LICENCIA
    {
        ...
        public DDU_LICENCIA(IDataReader reader, Query query = Query.None)
        {
            switch (query)
            {
                case Query.Listar:
                ...
                case Query.Consultar:
                    ...
                    TIPO_LICENCIA = reader.GetSafeString("TIPO_LICENCIA");
                    NUMERO_LICENCIA = reader.GetSafeString("NUMERO_LICENCIA");
                    GIROS = reader.GetSafeString("GIROS");
                    USO = reader.GetSafeString("USO");
                    ...
                    CODIGO_UNICO = reader.GetSafeString("CODIGO_UNICO");
